...
\centering
\includegraphics[width=\linewidth]{Figures/ecc_lib_diss}
\subcaption{\label{fig:diss_a}}
\end{subfigure}%
\begin{subfigure}{0.32\linewidth}
\centering
\includegraphics[width=\linewidth]{Figures/ecc_rad_diss}
\subcaption{\label{fig:diss_b}}
\end{subfigure}%
\begin{subfigure}{0.32\linewidth}
\centering
\includegraphics[width=\linewidth]{Figures/obliq_diss}
