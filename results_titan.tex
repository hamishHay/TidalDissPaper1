...
We calculate $de/dt$ for the eccentricity tide results in Figure \ref{fig:botEccTitan}, and use that to estimate a timescale over which the current eccentricity of 0.0288 dampens, $\tau_e = e/\dot{e}$. This is a first order estimate as both $dE/dt$ itself depends on the eccentricity. It is useful though to determine which areas of our considered parameter space fail to dampen Titan's eccentricity in a reasonable time period.
